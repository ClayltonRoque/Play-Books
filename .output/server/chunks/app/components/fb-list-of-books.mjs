...
var ids = fbListOfBooks$1.ids = [5, 1, 2, 3];
var modules = fbListOfBooks$1.modules = {
  /***/
  71: (
    /***/
...
const fbListOfBooks = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  default: fbListOfBooks$1,
  ids: ids,
  modules: modules
}, [fbListOfBooks$1]);

export { fbListOfBooks as f };
//# sourceMappingURL=fb-list-of-books.mjs.map
