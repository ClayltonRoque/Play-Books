...
var ids = fbBookCard$1.ids = [1, 3];
var modules = fbBookCard$1.modules = {
  /***/
  71: (
    /***/
...
const fbBookCard = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  default: fbBookCard$1,
  ids: ids,
  modules: modules
}, [fbBookCard$1]);

export { fbBookCard as f };
//# sourceMappingURL=fb-book-card.mjs.map
